  ...
  return (
    <div className="min-h-screen bg-[#E9F2FA] pt-28 pb-10">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {loading ? (
          <div className="flex justify-center p-20 text-gray-500 animate-pulse">
            Loading profile...
          </div>
        ) : profileData ? (
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-3xl shadow-sm border-b-4 border-blue-500">
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-blue-500 font-medium uppercase tracking-wider text-sm">
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 bg-orange-50/50 p-4 rounded-2xl border border-orange-100 italic">
                {profileData.profile.chronic_conditions ||
