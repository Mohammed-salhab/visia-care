...
const MOCK_OPTICAL_SHOPS = [
  {
    ...
    rating: 4.8,
    image:
      "https://images.unsplash.com/photo-1577460551100-907ba84418ce?auto=format&fit=crop&q=80&w=1000",
    glasses: [
      {
        id: 101,
  ...
  },
  {
    ...
    rating: 4.5,
    image:
      "https://images.unsplash.com/photo-1562886812-41775a01195d?auto=format&fit=crop&q=80&w=1000",
    glasses: [
      {
        id: 201,
        ...
        type: "Prescription",
        image:
          "https://plus.unsplash.com/premium_photo-1675806067753-22870bb19c43?auto=format&fit=crop&q=80&w=1000",
      },
      {
        id: 202,
        ...
        type: "Reading",
        image:
          "https://images.unsplash.com/photo-1577803645773-f96470509666?auto=format&fit=crop&q=80&w=1000",
      },
    ],
  },
  {
    ...
    glasses: [
      {
        ...
        type: "Fashion",
        image:
          "https://images.unsplash.com/photo-1508296695146-25e9436d08a2?auto=format&fit=crop&q=80&w=1000",
      },
      {
        id: 302,
        ...
        type: "Sport",
        image:
          "https://images.unsplash.com/photo-1614715838608-aa5296d92e5c?auto=format&fit=crop&q=80&w=1000",
      },
      {
        id: 303,
        ...
        type: "Classic",
        image:
          "https://images.unsplash.com/photo-1533681018185-6891fd65a1b5?auto=format&fit=crop&q=80&w=1000",
      },
      {
        id: 304,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Find the perfect glasses from top-rated optical stores near you.
          </p>
        </div>
              ...
              <div className="p-6 bg-gray-50/50">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {shop.glasses.map((glass) => (
                    <div
                      key={glass.id}
                      className="group bg-white rounded-xl border border-gray-200 p-3 hover:border-[#1A2E44]/30 transition-all cursor-pointer"
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[#1A2E44] font-bold mt-1 text-sm">
                          {glass.price}
                        </p>
                      </div>
                    </div>
